...
my_pic = Image.open("1TouchATM.png")
...
createButton = Button(loginScreen, text="Create an Account", height=3, width=20, command=lambda: main.createScreen(1, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.5, rely=.725,
                                                                                                    anchor=CENTER)
helpLoginButton = Button(loginScreen, text="Help", height=2, width=10, command=lambda: main.createScreen(10, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.50, rely=.90, anchor=CENTER)
...
helpLoginLabel = Label(helpLoginScreen, text="Help Menu:", font=('Helvatical bold', 15)).place(relx=.5, rely=0.1, anchor=CENTER)
hLoginReturnButton = Button(helpLoginScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(11, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)
emailLoginLabel = Label(helpLoginScreen, text="help@onetouch.com", font=('Helvatical bold', 15)).place(relx=.5, rely=0.3, anchor=CENTER)
phoneNumberLoginLabel = Label(helpLoginScreen, text="214-696-9420", font=('Helvatical bold', 15)).place(relx=.5, rely=0.4, anchor=CENTER)
helpLoginImage = Label(helpLoginScreen, image=new_pic).place(relx=0.5, rely=.75, anchor=CENTER)

# welcome screen buttons and labels
welcomeImage = Label(welcomeScreen, image=new_pic).place(relx=0, rely=.15, anchor=W)
depositButton = Button(welcomeScreen, text="Deposit", height=3, width=20, command=lambda: main.createScreen(2, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.05, rely=.90, anchor=W)
withdrawButton = Button(welcomeScreen, text="Withdraw", height=3, width=20, command=lambda: main.createScreen(4, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.95, rely=.90, anchor=E)
helpButton = Button(welcomeScreen, text="Help", height=2, width=10, command=lambda: main.createScreen(6, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.50, rely=.90, anchor=CENTER)
BackButton = Button(welcomeScreen, text="Logout", height=3, width=10, command=lambda: main.createScreen(8, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.05, rely=.75, anchor=W)
...
createAccountButton = Button(createAccountScreen, text="Create Account", height=3, width=20, command = lambda: main.createAccount(createUsernameText.get(), createPasswordText.get(), createEmailText.get(), initialDepositText.get(), loginScreen, createAccountScreen, createUsernameText, createPasswordText, createEmailText, initialDepositText)).place(relx=0.5, rely=.8,
                                                                                                    anchor=CENTER)
createAccountBackButton = Button(createAccountScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(9, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)
...
dReturnButton = Button(depositScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(3, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)
...
wReturnButton = Button(withdrawScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(5, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)

helpLabel = Label(helpScreen, text="Help Menu:", font=('Helvatical bold', 15)).place(relx=.5, rely=0.1, anchor=CENTER)
hReturnButton = Button(helpScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(7, helpLoginScreen, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)
...
helpImage = Label(helpScreen, image=new_pic).place(relx=0.5, rely=.75, anchor=CENTER)
